...
public class PaymentDaoImpl extends AbstractCrudDaoImpl<Payment> implements PaymentDao {
    ...
    private final static String INSERT_INTO = "INSERT INTO payments(booking_id, user_id, amount, payment_date) VALUES (?,?,?,?) ";
    ...
    private static final String UPDATE_PAYMENT = "UPDATE payments " +
            "SET booking_id=?, user_id=?, amount=?, payment_date=? WHERE payment_id=?";
    ...
    protected void mapForInsertStatement(PreparedStatement preparedStatement, Payment entity) throws SQLException {
        ...
        preparedStatement.setInt(2, entity.getBooking().getUser().getId());
        preparedStatement.setInt(3, entity.getAmount());
        preparedStatement.setDate(4, Date.valueOf(entity.getPaymentDate()));
    }
    ...
    public void addBookingPayment(BookingDto bookingServiceById) {
        ...
        try (Connection connection = connector.getConnection();
            ...
            try {
                ...
                insertPaymentByParameters.setDate(4,Date.valueOf(now));
